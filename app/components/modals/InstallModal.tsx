...
export default function InstallModal({ isOpen, onClose, programTitle }: EnrollModalProps) {
          ...
          <>
            <div className="flex justify-between items-center p-6 border-b">
              <div>
                <h2 className="font-syne text-2xl font-bold text-[#0D1B2A]">
                  {programTitle.includes("Founders") ? "Join Waitlist" : "Install Now"}
                </h2>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <button
                ...
                className="w-full bg-[#009E8E] hover:bg-[#008478] text-white font-semibold py-3 rounded-xl transition-all mt-4 disabled:opacity-70"
              >
