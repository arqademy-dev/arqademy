      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-20">
        <div className="max-w-6xl w-full text-center mb-20">
          ...
          <p className="text-white/90 text-lg md:text-xl max-w-3xl mx-auto mb-8 leading-relaxed">
            Imagine African students equipped not only to receive, but also to
            create solutions for their communities and the world.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <Button
              ...
              size="lg"
              className="bg-white text-gray-900 flex items-center gap-1 hover:bg-white/90 px-8 py-6 text-lg group"
            >
              Get Started
      ...
      <div className="border-gray-100 flex flex-col items-center justify-center px-4 py-20 bg-white/5">
        <div className="max-w-6xl w-full grid grid-cols-1 sm:grid-cols-3 gap-12 text-center">
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-white/90 uppercase tracking-wide text-sm">
              States
            </span>
          </div>
